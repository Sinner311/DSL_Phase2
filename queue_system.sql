...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2025 at 05:22 PM
...
(624, 42, NULL, 'normal', 350, '2025-02-21', '08:30:00', '16:00:00'),
(625, 42, 43, 'normal', 2, '2025-02-24', '08:30:00', '16:00:00'),
(626, 42, 43, 'normal', 350, '2025-02-25', '08:30:00', '16:00:00'),
(627, NULL, 43, 'normal', 350, '2025-02-26', '08:30:00', '16:00:00'),
(628, NULL, 43, 'normal', 350, '2025-02-27', '08:30:00', '16:00:00'),
...
(3113, NULL, NULL, 'normal', 400, '2025-05-29', '08:30:00', '16:00:00'),
(3114, NULL, NULL, 'normal', 400, '2025-05-30', '08:30:00', '16:00:00'),
(3115, NULL, NULL, 'normal', 400, '2025-06-02', '08:30:00', '16:00:00'),
(3116, NULL, NULL, 'normal', 400, '2025-06-03', '08:30:00', '16:00:00'),
(3117, NULL, NULL, 'normal', 400, '2025-06-04', '08:30:00', '16:00:00'),
(3118, NULL, NULL, 'normal', 400, '2025-06-05', '08:30:00', '16:00:00'),
(3119, NULL, NULL, 'normal', 400, '2025-06-06', '08:30:00', '16:00:00'),
(3120, NULL, NULL, 'normal', 400, '2025-06-09', '08:30:00', '16:00:00'),
(3121, NULL, NULL, 'normal', 400, '2025-06-10', '08:30:00', '16:00:00'),
(3122, NULL, NULL, 'normal', 400, '2025-06-11', '08:30:00', '16:00:00'),
(3123, NULL, NULL, 'normal', 400, '2025-06-12', '08:30:00', '16:00:00'),
(3124, NULL, NULL, 'normal', 400, '2025-06-13', '08:30:00', '16:00:00'),
(3125, NULL, NULL, 'normal', 400, '2025-06-16', '08:30:00', '16:00:00'),
(3126, NULL, NULL, 'normal', 400, '2025-06-17', '08:30:00', '16:00:00'),
(3127, NULL, NULL, 'normal', 400, '2025-06-18', '08:30:00', '16:00:00'),
(3128, NULL, NULL, 'normal', 400, '2025-06-19', '08:30:00', '16:00:00');
...
(28, '2025-02-20 16:04:36', 12, 627, 'normal', 2);
...
CREATE TABLE `queues` (
  ...
  `queue_no` varchar(6) DEFAULT NULL,
...
(42, '2025-02-21', '2025-02-25', 7, 1, 1, 'normal'),
(43, '2025-02-24', '2025-02-27', 7, 1, 2, 'normal');
...
(1, 'nemopop148@gmail.com', NULL, 'JATESADA LEESUWAN', 'ADMIN', 1, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Im5lbW9wb3AxNDhAZ21haWwuY29tIiwicm9sZSI6IkFETUlOIiwiaWF0IjoxNzQwMDU1MzA5LCJleHAiOjE3NDAxNDE3MDl9.I8uKDxlKylw64fcRN8baljmOdk1MSe9g7oQLeuVW1-4'),
...
(12, '6531501141@lamduan.mfu.ac.th', '6531501141', 'JATESADA LEESUWAN', 'STUDENT', NULL, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6IjY1MzE1MDExNDFAbGFtZHVhbi5tZnUuYWMudGgiLCJyb2xlIjoiU1RVREVOVCIsImlhdCI6MTc0MDA1ODAxMiwiZXhwIjoxNzQwMTQ0NDEyfQ.A_hn_ExTfBZClL1ecOkpHyjiOu2YgObXvXn3qVQdvEU');
...
(1, 'normal', 7, 'ระบบปิดพักเบรคถึง 13:00 น.');
...
--
ALTER TABLE `days`
  MODIFY `dateid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3129;
...
--
ALTER TABLE `rounds`
  MODIFY `roundid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
