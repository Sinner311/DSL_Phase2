    ...
    <div class="container max-w-7xl px-4 py-2 mx-auto">
      <div class="flex justify-between items-center w-full">
        ...
        <div class="flex items-center space-x-4">
          ...
          <span class="text-red-500 lg:text-4xl font-bold">staff</span>
        </div>

        <!-- Right side: Logout Button -->
        <div class="hidden md:flex space-x-4">
          <button @click="confirmLogut" class="bg-indigo-900 hover:bg-indigo-700 text-white font-bold py-2 px-4 text-sm rounded-3xl">
